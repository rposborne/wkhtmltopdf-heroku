...
Gem::Specification.new do |s|
  ...
  s.date = %q{2011-09-08}
  s.description = %q{wkhtmltopdf binaries for OSX(darwin) and heroku}
  s.email = %q{bradphelan@xtargets.com}
  s.executables = [%q{wkhtmltopdf}, %q{wkhtmltopdf-darwin}, %q{wkhtmltopdf-linux-amd64}]
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.rdoc"
  ]
  ...
  s.summary = %q{wkhtmltopdf binaries for OSX(darwin) and heroku}
